...
MAX(CASE WHEN B.cot21 is not null AND B.cot21 <>'' THEN B.cot21 ELSE A.cot21 END) AS cot21
		from (select  dd.DepartmentID as DepartmentID, (dd.Tau + '_' + @posName) as Description, dd.DieuDongBacThangID,
		...
		LEFT JOIN 
			(select  dd.DepartmentID as DepartmentID, (dd.Tau + '_' + @posName) as Description, dd.DieuDongBacThangID,
