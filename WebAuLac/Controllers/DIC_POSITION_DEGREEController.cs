...
namespace WebAuLac.Controllers
{
    ...
    public class DIC_POSITION_DEGREEController : Controller
    {
        ...
        {
            ViewBag.idPos = id;
            return View(db.DIC_POSITION_DEGREE.Where(x =>x.PositionID==id).Include(x => x.DIC_POSITION).Include(x =>x.DIC_DEGREE).ToList());
        }
