...
namespace WebAuLac.Models
{
    ...
    public partial class DIC_TYPE_OF_RETRIBUTION
    {
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public DIC_TYPE_OF_RETRIBUTION()
        {
            this.HRM_EMPLOYEE_RETRIBUTION = new HashSet<HRM_EMPLOYEE_RETRIBUTION>();
        }
    
        public int TypeOfRetributionID { get; set; }
        public string TypeOfRetributionName { get; set; }
